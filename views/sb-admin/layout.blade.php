...
<head>
    ...
    <title> @yield('title', 'SB Admin') &mdash; Tópicos em Informática </title>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{ route('sb_admin') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>

                    <li>
                        <a href="{{ route('sb_admin',['page' => 'docs']) }}">
                            <i class="fa fa-files-o fa-fw"></i> Documentação rápida </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="fa fa-bar-chart-o fa-fw"></i> COMPONENTES <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('sb_admin', ['page' => 'tables'])  }}">
                                    <i class="fa fa-table fa-fw"></i> Tabelas
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('sb_admin',['page' => 'forms']) }}">
                                    <i class="fa fa-edit fa-fw"></i> Formulários
                                </a>
                            </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        @yield('header', 'SB Admin Templates')
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
